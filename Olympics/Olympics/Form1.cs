...
namespace Olympics
{
    public partial class Form1 : Form
    {
        ...
        int Helyezes(OlympicResult res)
        {
            ...
            {
                if (item.Medals[0] > res.Medals[0]) szamlalo++;
                else if ((item.Medals[0] == res.Medals[0]) && (item.Medals[1] > res.Medals[1])) szamlalo++;
                else if ((item.Medals[0] == res.Medals[0]) && (item.Medals[1] == res.Medals[1]) && (item.Medals[2] > res.Medals[2])) szamlalo++;
            
            }
            return szamlalo + 1;
        }

        private void EvFeltolt()
        {
